...
describe('versionResolver', () => {
    beforeEach(() => {
        ...
        (0, packageManager_1.clearVersionCache)();
    });
    describe('parseSemanticVersion', () => {
        it('should parse standard semantic versions', () => {
            const version = (0, packageManager_1.parseSemanticVersion)('6.1.3');
        ...
        it('should parse versions with prerelease', () => {
            const version = (0, packageManager_1.parseSemanticVersion)('6.1.3-beta.1');
            expect(version).toEqual({
                major: 6,
                minor: 1,
                patch: 3,
        ...
        it('should parse versions with build metadata', () => {
            const version = (0, packageManager_1.parseSemanticVersion)('6.1.3+build.123');
            expect(version).toEqual({
                major: 6,
                minor: 1,
                patch: 3,
        ...
        it('should handle latest version', () => {
            const version = (0, packageManager_1.parseSemanticVersion)('latest');
            expect(version).toEqual({
                major: 999,
                minor: 999,
                patch: 999,
        ...
        it('should return null for invalid versions', () => {
            expect((0, packageManager_1.parseSemanticVersion)('invalid')).toBeNull();
            expect((0, packageManager_1.parseSemanticVersion)('')).toBeNull();
            expect((0, packageManager_1.parseSemanticVersion)('1.2')).toBeNull();
        });
    });
    describe('compareVersions', () => {
        it('should compare major versions correctly', () => {
            const v1 = (0, packageManager_1.parseSemanticVersion)('6.0.0');
            const v2 = (0, packageManager_1.parseSemanticVersion)('7.0.0');
            expect((0, packageManager_1.compareVersions)(v1, v2)).toBeLessThan(0);
            expect((0, packageManager_1.compareVersions)(v2, v1)).toBeGreaterThan(0);
        });
        it('should compare minor versions correctly', () => {
            const v1 = (0, packageManager_1.parseSemanticVersion)('6.1.0');
            const v2 = (0, packageManager_1.parseSemanticVersion)('6.2.0');
            expect((0, packageManager_1.compareVersions)(v1, v2)).toBeLessThan(0);
            expect((0, packageManager_1.compareVersions)(v2, v1)).toBeGreaterThan(0);
        });
        it('should compare patch versions correctly', () => {
            const v1 = (0, packageManager_1.parseSemanticVersion)('6.1.1');
            const v2 = (0, packageManager_1.parseSemanticVersion)('6.1.2');
            expect((0, packageManager_1.compareVersions)(v1, v2)).toBeLessThan(0);
            expect((0, packageManager_1.compareVersions)(v2, v1)).toBeGreaterThan(0);
        });
        it('should handle equal versions', () => {
            const v1 = (0, packageManager_1.parseSemanticVersion)('6.1.3');
            const v2 = (0, packageManager_1.parseSemanticVersion)('6.1.3');
            expect((0, packageManager_1.compareVersions)(v1, v2)).toBe(0);
        });
        it('should handle prerelease versions correctly', () => {
            const release = (0, packageManager_1.parseSemanticVersion)('6.1.3');
            const prerelease = (0, packageManager_1.parseSemanticVersion)('6.1.3-beta.1');
            expect((0, packageManager_1.compareVersions)(prerelease, release)).toBeLessThan(0);
            expect((0, packageManager_1.compareVersions)(release, prerelease)).toBeGreaterThan(0);
        });
        it('should handle prerelease version comparisons', () => {
            const version1 = (0, packageManager_1.parseSemanticVersion)('1.0.0-alpha');
            const version2 = (0, packageManager_1.parseSemanticVersion)('1.0.0-beta');
            expect(version1).not.toBeNull();
            expect(version2).not.toBeNull();
            const result = (0, packageManager_1.compareVersions)(version1, version2);
            expect(result).toBeLessThan(0); // alpha < beta
        });
    });
    describe('satisfiesRange', () => {
        const version613 = (0, packageManager_1.parseSemanticVersion)('6.1.3');
        const version620 = (0, packageManager_1.parseSemanticVersion)('6.2.0');
        const version700 = (0, packageManager_1.parseSemanticVersion)('7.0.0');
        it('should handle caret ranges correctly', () => {
            expect((0, packageManager_1.satisfiesRange)(version613, '^6.0.0')).toBe(true);
            expect((0, packageManager_1.satisfiesRange)(version620, '^6.0.0')).toBe(true);
            expect((0, packageManager_1.satisfiesRange)(version700, '^6.0.0')).toBe(false);
        });
        it('should handle tilde ranges correctly', () => {
            expect((0, packageManager_1.satisfiesRange)(version613, '~6.1.0')).toBe(true);
            expect((0, packageManager_1.satisfiesRange)(version620, '~6.1.0')).toBe(false);
        });
        it('should handle exact versions correctly', () => {
            expect((0, packageManager_1.satisfiesRange)(version613, '6.1.3')).toBe(true);
            expect((0, packageManager_1.satisfiesRange)(version620, '6.1.3')).toBe(false);
        });
        it('should handle greater than or equal ranges', () => {
            expect((0, packageManager_1.satisfiesRange)(version613, '>=6.1.0')).toBe(true);
            expect((0, packageManager_1.satisfiesRange)(version613, '>=6.2.0')).toBe(false);
        });
        it('should handle latest range', () => {
            expect((0, packageManager_1.satisfiesRange)(version613, 'latest')).toBe(true);
            expect((0, packageManager_1.satisfiesRange)(version700, 'latest')).toBe(true);
        });
    });
    describe('findBestAvailableVersion', () => {
        const availableVersions = ['6.0.0', '6.1.0', '6.1.3', '6.2.0', '7.0.0'];
        it('should find exact matches', () => {
            const result = (0, packageManager_1.findBestAvailableVersion)(availableVersions, '6.1.3');
            expect(result).toBe('6.1.3');
        });
        it('should find best compatible version for caret ranges', () => {
            const result = (0, packageManager_1.findBestAvailableVersion)(availableVersions, '^6.1.0');
        ...
        it('should fallback to newest version when no compatible version found', () => {
            const result = (0, packageManager_1.findBestAvailableVersion)(availableVersions, '^8.0.0');
            expect(result).toBe('7.0.0'); // Newest available version
        });
        it('should handle empty available versions', () => {
            const result = (0, packageManager_1.findBestAvailableVersion)([], '6.1.3');
            expect(result).toBeNull();
        });
        it('should handle latest requirement', () => {
            const result = (0, packageManager_1.findBestAvailableVersion)(availableVersions, 'latest');
    ...
    describe('resolveCdsVersions', () => {
        ...
        it('should resolve exact matches successfully', () => {
            const result = (0, packageManager_1.resolveCdsVersions)('6.1.3', '6.0.0');
        ...
        it('should resolve compatible versions with warnings', () => {
            const result = (0, packageManager_1.resolveCdsVersions)('^6.1.0', '^6.0.0');
        ...
        it('should handle unavailable versions gracefully', () => {
            const result = (0, packageManager_1.resolveCdsVersions)('8.0.0', '8.0.0');
        ...
        it('should handle latest versions correctly', () => {
            const result = (0, packageManager_1.resolveCdsVersions)('latest', 'latest');
        ...
        it('should handle single version string from npm view', () => {
            ...
            const result = (0, packageManager_1.resolveCdsVersions)('6.1.3', '6.1.3');
            expect(result.resolvedCdsVersion).toBe('6.1.3');
        });
    ...
    describe('checkVersionCompatibility', () => {
        it('should handle cases where versions cannot be parsed', () => {
            const result = (0, packageManager_1.checkVersionCompatibility)('invalid-version', '6.0.0');
            expect(result.isCompatible).toBe(false);
            expect(result.warning).toContain('Unable to parse version numbers');
        });
        it('should handle major version mismatches', () => {
            const result = (0, packageManager_1.checkVersionCompatibility)('5.1.0', '6.0.0');
            expect(result.isCompatible).toBe(false);
            expect(result.warning).toContain('Major version mismatch');
        });
        it('should handle minor version differences with warning', () => {
            const result = (0, packageManager_1.checkVersionCompatibility)('6.1.0', '6.2.0');
            expect(result.isCompatible).toBe(true);
            expect(result.warning).toContain('Minor version difference');
        });
        it('should handle compatible versions without warnings', () => {
            const result = (0, packageManager_1.checkVersionCompatibility)('6.1.3', '6.1.3');
            expect(result.isCompatible).toBe(true);
            expect(result.warning).toBeUndefined();
        });
        it('should handle latest versions', () => {
            const result = (0, packageManager_1.checkVersionCompatibility)('latest', '6.0.0');
            expect(result.isCompatible).toBe(true);
            expect(result.warning).toBeUndefined();
        });
    });
    describe('getAvailableVersions', () => {
        ...
        it('should handle npm timeout errors', () => {
            ...
            const result = (0, packageManager_1.getAvailableVersions)('@sap/cds');
        ...
        it('should use cached results on subsequent calls', () => {
            ...
            const result1 = (0, packageManager_1.getAvailableVersions)('@sap/cds');
            expect(result1).toEqual(['6.1.3', '6.2.0']);
            // Reset mock to ensure cache is used
            mockExecSync.mockReset();
            // Second call should use cache
            const result2 = (0, packageManager_1.getAvailableVersions)('@sap/cds');
    ...
    describe('satisfiesRange - additional edge cases', () => {
        it('should handle greater than ranges', () => {
            const version = (0, packageManager_1.parseSemanticVersion)('6.2.0');
            expect((0, packageManager_1.satisfiesRange)(version, '>6.1.0')).toBe(true);
            expect((0, packageManager_1.satisfiesRange)(version, '>6.2.0')).toBe(false);
        });
        it('should handle less than or equal ranges', () => {
            const version = (0, packageManager_1.parseSemanticVersion)('6.1.0');
            expect((0, packageManager_1.satisfiesRange)(version, '<=6.1.0')).toBe(true);
            expect((0, packageManager_1.satisfiesRange)(version, '<=6.0.0')).toBe(false);
        });
        it('should handle less than ranges', () => {
            const version = (0, packageManager_1.parseSemanticVersion)('6.1.0');
            expect((0, packageManager_1.satisfiesRange)(version, '<6.2.0')).toBe(true);
            expect((0, packageManager_1.satisfiesRange)(version, '<6.1.0')).toBe(false);
        });
        it('should handle invalid range patterns', () => {
            const version = (0, packageManager_1.parseSemanticVersion)('6.1.0');
            expect((0, packageManager_1.satisfiesRange)(version, 'invalid-range')).toBe(false);
        });
    });
    describe('findBestAvailableVersion - edge cases', () => {
        ...
        it('should handle complex version ranges', () => {
            ...
            const result = (0, packageManager_1.findBestAvailableVersion)(availableVersions, '~6.0.0');
    ...
    describe('cache statistics and management', () => {
        ...
        it('should track cache statistics correctly', () => {
            ...
            let stats = (0, packageManager_1.getCacheStatistics)();
            expect(stats.hits).toBe(0);
            expect(stats.misses).toBe(0);
            // First call creates cache miss
            (0, packageManager_1.getAvailableVersions)('@sap/cds');
            stats = (0, packageManager_1.getCacheStatistics)();
            expect(stats.hits).toBe(0);
        ...
        it('should log cache statistics', () => {
            ...
            expect(() => (0, packageManager_1.logCacheStatistics)()).not.toThrow();
        });
    });
});
//# sourceMappingURL=versionResolver.test.js.map