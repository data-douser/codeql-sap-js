...
describe('CDS Parser - Subdirectory File Detection', () => {
    ...
    describe('determineCdsFilesForProjectDir', () => {
        it('should find CDS files in valid subdirectories and exclude node_modules', () => {
            ...
            const files = (0, functions_1.determineCdsFilesForProjectDir)('/project', '/project');
        ...
        it('should return empty array for project with no CDS files', () => {
            ...
            const files = (0, functions_1.determineCdsFilesForProjectDir)('/empty-project', '/empty-project');
        ...
        it('should throw error if projectDir is not subdirectory of sourceRootDir', () => {
            ...
            expect(() => {
                (0, functions_1.determineCdsFilesForProjectDir)('/project-a', '/project-b');
        ...
        it('should allow projectDir to be equal to sourceRootDir', () => {
            ...
            const files = (0, functions_1.determineCdsFilesForProjectDir)('/project-root', '/project-root');
            expect(files).toContain('main.cds');
            expect(files).toContain('db/schema.cds');
            expect(files).toContain('srv/service.cds');
            expect(files.length).toBe(3);
        ...
        it('should throw error if parameters are missing', () => {
            expect(() => {
                (0, functions_1.determineCdsFilesForProjectDir)('', '/project');
            }).toThrow('both sourceRootDir and projectDir must be provided');
            expect(() => {
                (0, functions_1.determineCdsFilesForProjectDir)('/root', '');
            }).toThrow('both sourceRootDir and projectDir must be provided');
        });
    });
    ...
    describe('isLikelyCdsProject', () => {
        it('should identify CDS projects correctly', () => {
            ...
            expect((0, functions_1.isLikelyCdsProject)('/cds-with-deps')).toBe(true);
            expect((0, functions_1.isLikelyCdsProject)('/cds-with-files')).toBe(true);
            expect((0, functions_1.isLikelyCdsProject)('/standalone-cds')).toBe(true);
            expect((0, functions_1.isLikelyCdsProject)('/not-cds')).toBe(false);
        });
    });
    describe('Node modules exclusion regression tests', () => {
        it('should handle complex node_modules scenarios', () => {
            ...
            const files = (0, functions_1.determineCdsFilesForProjectDir)('/complex-project', '/complex-project');
...
//# sourceMappingURL=subdirectory-detection.test.js.map