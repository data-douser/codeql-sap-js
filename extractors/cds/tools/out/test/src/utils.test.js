...
describe('utils', () => {
    ...
    describe('validateArguments', () => {
        ...
        it('should return true when argument count matches required count', () => {
            ...
            const result = (0, utils_1.validateArguments)(args, 4);
        ...
        it('should return false and print warning when argument count does not match required count', () => {
            ...
            expect(console.warn).toHaveBeenCalledWith('Usage: node index-files.js <response-file> <source-root>');
        });
        it('should use fallback script name when not provided', () => {
            const args = ['node'];
            const result = (0, utils_1.validateArguments)(args, 3);
            expect(result).toBe(false);
