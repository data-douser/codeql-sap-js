...
function getReqData(request) {
  return request.data;  // UNSAFE: Taint source, Exposed service (fallback)
}

function getReqParams(request) {
  return request.params;  // UNSAFE: Taint source, Exposed service (fallback)
}

function getReqHeaders(request) {
  return request.headers;  // UNSAFE: Taint source, Exposed service (fallback)
}

function getReqId(request) {
  return request.id;  // UNSAFE: Taint source, Exposed service (fallback)
}

function getReqQueryOptions(request) {
  return request._queryOptions;  // UNSAFE: Taint source, Exposed service (fallback)
}